...
def make_figure(
    ...
    display_name = {
        row.Feature_Name: wrap_label(row.Feature_Name, width=30)
    ...
    fig = plt.figure(figsize=(18.0, fig_height), constrained_layout=False)
    gs = fig.add_gridspec(
        1, 3,
        width_ratios=[1.05, 1.05, 1.65],
        wspace=0.62,
        left=0.055,
        right=0.985,
        top=0.92,
    ...
    ax_c.tick_params(axis="y", labelsize=7.6)
